...
Sparkle’s `**generate_appcast**` can build or refresh appcast entries from a folder of release artifacts; pass your private key (keychain or file) per Sparkle’s help output. Point the tool at the same DMG URLs you upload to GitHub.